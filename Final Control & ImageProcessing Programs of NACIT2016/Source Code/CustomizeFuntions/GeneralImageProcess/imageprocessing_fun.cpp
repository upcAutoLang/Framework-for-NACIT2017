...
//{
//    bool HSVInfo1_have = true;
//    bool HSVInfo2_have = true;
//    bool RGBVoice1_have = true;
//    bool RGBVoice2_have = true;

////    cout<<HSVInfo1.HMin<<" "<<HSVInfo1.HMax<<" "<<HSVInfo1.SMin<<endl;
////    cout<<HSVInfo2.HMin<<" "<<HSVInfo2.HMax<<" "<<HSVInfo2.SMin<<endl;
////    cout<<RGBVoice1.RMin<<" "<<RGBVoice1.RMax<<" "<<RGBVoice1.RMin<<endl;
////    cout<<RGBVoice2.RMin<<" "<<RGBVoice2.RMax<<" "<<RGBVoice2.RMin<<endl;
////    cout<<endl;

//    // 判断是否存在这几个信息阈值
//    if(HSVInfo1.HMin < 0 && HSVInfo1.HMax < 0
//            && HSVInfo1.SMin < 0 && HSVInfo1.SMax < 0
//            && HSVInfo1.VMin < 0 && HSVInfo1.VMax < 0)
//    {
//        HSVInfo1_have = false;
//        cout<<"Have No HSVInfo1"<<endl;
//    }
//    if(HSVInfo2.HMin < 0 && HSVInfo2.HMax < 0
//            && HSVInfo2.SMin < 0 && HSVInfo2.SMax < 0
//            && HSVInfo2.VMin < 0 && HSVInfo2.VMax < 0)
//    {
//        HSVInfo2_have = false;
//        cout<<"Have No HSVInfo2"<<endl;
//    }
//    if(RGBVoice1.RMin < 0 && RGBVoice1.RMax < 0
//            && RGBVoice1.GMin < 0 && RGBVoice1.GMax < 0
//            && RGBVoice1.BMin < 0 && RGBVoice1.BMax < 0)
//    {
//        RGBVoice1_have = false;
//        cout<<"Have No RGBVoice1"<<endl;
//    }
//    if(RGBVoice2.RMin < 0 && RGBVoice2.RMax < 0
//            && RGBVoice2.GMin < 0 && RGBVoice2.GMax < 0
//            && RGBVoice2.BMin < 0 && RGBVoice2.BMax < 0)
//    {
//        RGBVoice2_have = false;
//        cout<<"Have No RGBVoice2"<<endl;
//    }
...
//    // 将各个信息存于缓存文件中
//    HSVThresh(src, tmp1, HSVInfo1);
//    if(HSVInfo2_have)
//        HSVThresh(src, tmp2, HSVInfo2);
//    if(RGBVoice1_have)
//        RGBThresh(src, tmp3, RGBVoice1);
//    if(RGBVoice2_have)
//        RGBThresh(src, tmp4, RGBVoice2);

//    // 缓存文件作并、减运算
//    tmp1.copyTo(tmp);
//    BinMatJoin(tmp, tmp2, tmp);
//    BinMatMinus(tmp, tmp3, tmp);
//    BinMatMinus(tmp, tmp4, tmp);
